  ...
  return (
    <div>
      ...
      <div className='p-7 max-w-4xl mx-auto' >
        <h1 className='text-3xl font-semibold text-center my-7 pt-9'>Create a Listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
          <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex flex-col gap-4'>
              <Select options={countries} required value={country} onChange={handleCountryChange} placeholder="Select Country" className='w-full' />
              <Select options={states} required value={state} onChange={handleStateChange} placeholder="Select State" className='w-full'  />
              <Select options={cities} required value={city} onChange={handleCityChange} placeholder="Select City" className='w-full'  />
            </div>
